(function () {
    ...
    var columnsToShow = ['No Entry', 'Prep', 'Ready for Dev', 'In Dev', 'Rally Rollout', 'Archived'];
    /**
     * PI Kanban Board App
    ...
    Ext.define('Rally.app.portfoliokanban.PortfolioKanbanApp', {
        ...
        _loadStates:function (options) {
            var filter;
            Ext.each(columnsToShow, function (columnName) {
                var current = Ext.create('Rally.data.QueryFilter', {
                    property:'Name',
                    operator:'=',
                    value:columnName
                });
